...
<body>
	...
	<script src="js/viewer/Global.js"></script>	
	<script src="js/viewer/IdeViewer.js"></script>
	<script src="js/viewer/main/OutlinePanel.js"></script>
	<script src="js/viewer/main/toolbar/Toolbar.js"></script>
	<script src="js/viewer/main/codePanel/CodePanel.js"></script>
	<script src="js/viewer/main/codePanel/CodeTab.js"></script>
	<script src="js/viewer/main/ConsolePanel.js"></script>
	<script src="js/viewer/main/ExplorerPanel.js"></script>
	<script src="js/viewer/main/toolbar/run/JavaWeb.js"></script>
	<script src="js/viewer/main/toolbar/tenxcloud/tenxcloud.js"></script>
	<script src="js/viewer/main/toolbar/window/Preferences.js"></script>
	<script src="js/viewer/others/Dialog.js"></script>
